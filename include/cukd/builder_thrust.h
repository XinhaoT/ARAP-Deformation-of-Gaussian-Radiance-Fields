...
namespace cukd {
  ...
  */
  ...
  namespace thrustSortBuilder {
    ...
    */
                            ...
                            int L)
    {
      ...
      const scalar_t pivotCoord = data_traits::get_coord(data_traits::get_point(d_nodes[pivotPos]),pivotDim);
       ...
       const thrust::tuple<uint32_t, data_t> &b)
    {
      ...
      int dim
        ...
        // : this->dim;
      const auto coord_a = data_traits::get_coord(data_traits::get_point(pnt_a),dim);
      const auto coord_b = data_traits::get_coord(data_traits::get_point(pnt_b),dim);
                        ...
                        GpuMemoryResource &memResource)
  {
    ...
    std::cout << "buildtree thrust total level: " << deepestLevel << std::endl;
