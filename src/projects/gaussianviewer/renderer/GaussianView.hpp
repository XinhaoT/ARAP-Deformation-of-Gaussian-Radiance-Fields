...
namespace sibr { 
	...
	public:
		...
		void UpdateRotationAndSHs(const DeformGraph &dm);
		void UpdateBlockCenter();
		void getQuadMesh();
		void getCentersMesh();
		void getSamplesMesh();
		void getOverallAABB();
		...
		void BuildSamplesPerGs(unsigned int gs_idx, std::set<int>& current_sps_idx);
		void FastBuildSamplesPerGs(unsigned int gs_idx);
		void FastBuildSamplesNeighbourGs();
		void UpdateSamplesNeighbourGs();
		void SetupSamplesFeatures();
		void UpdateGsHalfLengths();
		void UpdateSamplesInfos();
		void FASTUpdateSamplesNeighbourGs();
		void UpdateFromOptimizedFeatures(double* features);
		void GPUSetupSamplesFeatures();
		void GPUOptimize();
		void GPUCalculateGrad();
		void CPUCalculateGrad();
